...
namespace F10Y.L0030
{
    ...
    public partial interface IIdentityStringOperator
    {
        ...
        string Append_ElementTypeRelationshipMarkers(
            string typeName,
        ...
        string Get_GenericTypeParameterCountToken(int genericTypeParameterCount)
        {
        ...
        string Get_GenericMethodParameterCountToken(int genericMethodParameterCount)
        {
            var output = this.Get_GenericParameterCountToken(
        ...
        string Get_ErrorIdentityString(string identityStringValue)
        {
            var output = Instances.KindMarkerOperator.Make_ErrorKindMarked(identityStringValue);
            return output;
        }

        string Get_EventIdentityString(string identityStringValue)
        {
            var output = Instances.KindMarkerOperator.Make_EventKindMarked(identityStringValue);
            return output;
        }

        string Get_FieldIdentityString(string identityStringValue)
        {
        ...
        string Get_IdentityString(MemberInfo memberInfo)
        {
        ...
        string Get_MethodIdentityString(string identityStringValue)
        {
            var output = Instances.KindMarkerOperator.Make_MethodKindMarked(identityStringValue);
            return output;
        }

        string Get_PropertyIdentityString(string identityStringValue)
        {
            var output = Instances.KindMarkerOperator.Make_PropertyKindMarked(identityStringValue);
            return output;
        }

        string Get_TypeIdentityString(string identityStringValue)
        {
        ...
        string Modify_MemberName(string name)
        {
